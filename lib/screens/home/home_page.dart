...
class HomePage extends StatelessWidget{
  ...
  final List<Note> note = [Note(title: "Ttitre1", desc: "desc1"), Note(title: "Ttitre2", desc: "desc2"), Note(title: "Ttitre3", desc: "desc3")];
  @override
      ...
      body: Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, i){
            return NoteItem(title: this.note[i].title, desc: this.note[i].desc,);
          },
        )
